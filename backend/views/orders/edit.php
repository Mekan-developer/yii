...
<?php $form = ActiveForm::begin(['options' => ['autocomplete' => 'off', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return orderProductsCheck()']]); ?>
...
<div class="card mt-2">
    <div class="card-content">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'number')->textInput(['class' => 'form-control', 'readonly' => true, 'disabled' => true]) ?>
                </div>
                <div class="col-md-6">
            ...
            <div class="form-group mb-2">
                <?php echo \backend\widgets\OrderProductsWidget::widget(['model' => $model]) ?>
            </div>
